...
function ChoiceTrans() {
    ...
    async function onSubmit(event) {
        ...
        try {
            ...
            if (result.status === 200) {
                console.log(result);
                navigate("/createplan/showselectionNo", {state: {selectedStartDate, selectedEndDate, diff, selectedHostels, selectedRecommedYn : 'N', selectedSights, selectedTrans, title}})
    ...
    // 페이지 이동
    // const moveNextClick = () => {
    //     navigate('/createplan/showselectionNo', {state: {selectedStartDate, selectedEndDate, selectedHostels, selectedRecommedYn : 'N', selectedSights, selectedTrans, title}})
    // }
